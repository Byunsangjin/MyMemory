...
//  MyMemory
//
//  Created by Byunsangjin on 02/10/2018.
...
class SideBarVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let headerView = UIView(frame: CGRect(x: 0, y: 0, width: self.view.frame.size.width, height: 70))
        ...
        self.emailLabel.text = "qustkdwls1@naver.com"
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.row == 0 { // 선택된 행이 새글 작성 메뉴 일 때
